...
router.post('/', upload.single('image'), async (req, res) => {
  try {
    ...
    // Sanitize filename to replace spaces with underscores and remove special characters
...
router.post('/delete-image', async (req, res) => {
  try {
    ...
    console.log(`Attempting S3 deletion from Bucket [${bucketName}] with params:`, deleteParams);
